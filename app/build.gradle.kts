...
android {
    ...
    composeOptions {
        kotlinCompilerExtensionVersion = "2.5.0"
    }
}
...
dependencies {
    ...
    // Compose BOM (controls versions of Compose libraries)
    ...
    // Force Material3 version to prevent duplicate classes
    configurations.all {
        resolutionStrategy {
    ...
    // Coil for Compose (stable image loading)
    ...
    // Accompanist placeholder (optional for loading UI)
